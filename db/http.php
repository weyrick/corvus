...
class HttpRequest  {
	 ...
	 * @return bool Returns true on success or false on failure.
	 */
	public function setOptions ($options = nullarray ) {}
	 ...
	 * @return bool Returns true on success or false on failure.
	 */
	public function setSslOptions ($options = nullarray ) {}
	 ...
	 * @return bool Returns true on success or false on failure.
	 */
	public function setHeaders ($headers = nullarray ) {}
	 ...
	 * @return bool Returns true on success or false on failure.
	 */
	public function setCookies ($cookies = nullarray ) {}
	 ...
	 * </p>
	 * @return array an array of stdClass objects like http_parse_cookie would return.
	 */
	public function getResponseCookies ($flags = null, $allowed_extras = nullarray ) {}
...
class HttpRequestPool implements Countable, Iterator, Traversable {
	 ...
	 * @return void 
	 */
	public function __construct ($request = nullHttpRequest ) {}
	 ...
	 * @return bool Returns true on success or false on failure.
	 */
	public function attach ($requestHttpRequest ) {}
	 ...
	 * @return bool Returns true on success or false on failure.
	 */
	public function detach ($requestHttpRequest ) {}
...
class HttpResponse  {
	 ...
	 * @return void 
	 */
	public static function redirect ($url = null, $params = nullarray , $session = null, $status = null) {}
 ...
 */
function http_build_url ($url = null, $parts = null, $flags = null, &$new_url = nullarray ) {}
 ...
 */
function http_negotiate_language ($supportedarray , &$result = nullarray ) {}
 ...
 */
function http_negotiate_charset ($supportedarray , &$result = nullarray ) {}
 ...
 */
function http_negotiate_content_type ($supportedarray , &$result = nullarray ) {}
 ...
 */
function http_redirect ($url = null, $params = nullarray , $session = null, $status = null) {}
 ...
 * </p>
 * @return object a stdClass object on success&return.falseforfailure;.
 */
function http_parse_cookie ($cookie, $flags = null, $allowed_extras = nullarray ) {}
 ...
 * Parse flags
 * </p>
 * @return object parameter list as stdClass object.
 */
 ...
 * @return object persistent handles statistics as stdClass object on success&return.falseforfailure;.
 */
 ...
 */
function http_get ($url, $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_head ($url = null, $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_post_data ($url, $data = null, $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_post_fields ($url, $data = nullarray , $files = nullarray , $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_put_data ($url, $data = null, $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_put_file ($url, $file = null, $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_put_stream ($url, $stream = null, $options = nullarray , &$info = nullarray ) {}
 ...
 * @return string &returns.http.response;
 */
function http_request ($method, $url = null, $body = null, $options = nullarray , &$info = nullarray ) {}
